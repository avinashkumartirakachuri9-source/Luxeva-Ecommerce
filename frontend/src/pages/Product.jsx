    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
          ...
          <div className="flex flex-col gap-4 my-8">
            ...
            <div className="flex gap-2 ">
              {productData.sizes.map((item,index)=>(
                <button onClick={()=>setSize(item)} className={`outline outline-gray-400 px-2 py-1 rounded-sm cursor-pointer ${item===size?'outline-orange-500':''}`} key={index}>{item}</button>
              ))}
            </div>
          </div>
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border border-gray-400 px-6 py-6 text-sm text-gray-500">
          ...
          <p className="">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ea beatae porro ipsa dolorem iusto natus molestias tempora ipsam veritatis, laborum repudiandae accusantium, hic animi deserunt dignissimos placeat laboriosam ullam nemo.</p>
        </div>
      </div>
